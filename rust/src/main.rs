...
fn main() {
    ...
    let s = match day.as_str() {
        ...
        "14" => d14::Solver.solve(&input),
        "15" => d15::Solver.solve(&input),
        "16" => d16::Solver.solve(&input),
        "17" => d17::Solver.solve(&input),
        "18" => d18::Solver.solve(&input),
        "19" => d19::Solver.solve(&input),
        "20" => d20::Solver.solve(&input),
        _ => panic!("invalid day")
    };
